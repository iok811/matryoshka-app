...
Riferimento pronto da usare quando implementeremo lo sblocco a pagamento. Non è ancora codice — è la specifica esatta, così quando procediamo non dobbiamo improvvisare le regole mentre scriviamo.
...
Per ogni sezione filtrata per livello: **non nascondere il pulsante del livello A2-C2** — mostralo, ma al click apri una schermata con:
